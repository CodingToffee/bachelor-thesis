...
\usepackage[]{acronym}
\usepackage{circuitikz} % for circuit schematics
...
\include{./doc/101Introduction} % Einleitung
\include{./doc/102Foundations}
\include{./doc/102RelatedWork}
\include{./doc/103RequirementsAnalysis}
\include{./doc/104Implementation}
